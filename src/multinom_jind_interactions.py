...
SPECIFICATIONS = {
    "spec_expression_jind_reform": {
        "vars": ["wdj_expression_lag1", "j_ind_lag1", "v2jureform_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_expression_lag1", "j_ind_lag1"),
    },
    "spec_expression_jind_attack": {
        "vars": ["wdj_expression_lag1", "j_ind_lag1", "v2jupoatck_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_expression_lag1", "j_ind_lag1"),
    },
    "spec_expression_jind_pack": {
        "vars": ["wdj_expression_lag1", "j_ind_lag1", "v2jupack_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_expression_lag1", "j_ind_lag1"),
    },
    "spec_expression_jind_purge": {
        "vars": ["wdj_expression_lag1", "j_ind_lag1", "v2jupurge_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_expression_lag1", "j_ind_lag1"),
    },
    "spec_citizen_jind_reform": {
        "vars": ["wdj_citizen_lag1", "j_ind_lag1", "v2jureform_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_citizen_lag1", "j_ind_lag1"),
    },
    "spec_citizen_jind_attack": {
        "vars": ["wdj_citizen_lag1", "j_ind_lag1", "v2jupoatck_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_citizen_lag1", "j_ind_lag1"),
    },
    "spec_citizen_jind_pack": {
        "vars": ["wdj_citizen_lag1", "j_ind_lag1", "v2jupack_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_citizen_lag1", "j_ind_lag1"),
    },
    "spec_citizen_jind_purge": {
        "vars": ["wdj_citizen_lag1", "j_ind_lag1", "v2jupurge_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_citizen_lag1", "j_ind_lag1"),
    },
    "spec_press_jind_reform": {
        "vars": ["wdj_press_lag1", "j_ind_lag1", "v2jureform_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_press_lag1", "j_ind_lag1"),
    },
    "spec_press_jind_attack": {
        "vars": ["wdj_press_lag1", "j_ind_lag1", "v2jupoatck_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_press_lag1", "j_ind_lag1"),
    },
    "spec_press_jind_pack": {
        "vars": ["wdj_press_lag1", "j_ind_lag1", "v2jupack_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_press_lag1", "j_ind_lag1"),
    },
    "spec_press_jind_purge": {
        "vars": ["wdj_press_lag1", "j_ind_lag1", "v2jupurge_lag1"] + CONTROLS_NO_JIND,
        "spline": False,
        "interaction": False,
        "moderator_interaction": ("wdj_press_lag1", "j_ind_lag1"),
    },
...
print(f"Number of specifications: {len(SPECIFICATIONS)}")
...
def build_X(data, spec):
    """
    Creates design matrix with optional spline + interaction and moderator interaction.
    ...
    if spec.get("moderator_interaction"):
        predictor, moderator = spec["moderator_interaction"]
        rhs_terms.append(f"{predictor} * {moderator}")
...
for spec_name, spec in SPECIFICATIONS.items():
    ...
    # design matrix
    X = build_X(data, spec)
    print(f"Design-matrix columns for {spec_name}: {X.columns.tolist()}")
    ...
    print(f"N: {int(result.nobs)}, converged: {result.mle_retvals['converged']}")
